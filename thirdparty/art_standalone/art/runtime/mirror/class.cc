...
ObjPtr<String> Class::ComputeName(Handle<Class> h_this) {
  ...
  if ((descriptor[0] != 'L') && (descriptor[0] != '[')) {
    ...
    const char* c_name_fixme2 = nullptr;
    switch (descriptor[0]) {
    case 'Z': c_name_fixme2 = "boolean"; break;
    case 'B': c_name_fixme2 = "byte";    break;
    case 'C': c_name_fixme2 = "char";    break;
    case 'S': c_name_fixme2 = "short";   break;
    case 'I': c_name_fixme2 = "int";     break;
    case 'J': c_name_fixme2 = "long";    break;
    case 'F': c_name_fixme2 = "float";   break;
    case 'D': c_name_fixme2 = "double";  break;
    case 'V': c_name_fixme2 = "void";    break;
    default:
      LOG(FATAL) << "Unknown primitive type: " << PrintableChar(descriptor[0]);
    }
    name = String::AllocFromModifiedUtf8(self, c_name_fixme2);
  } else {

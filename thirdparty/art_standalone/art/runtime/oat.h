...
class PACKED(4) OatHeader {
 public:
  ...
  static __attribute__((visibility("default"))) constexpr const char kTrueValue[] = "true";
  static __attribute__((visibility("default"))) constexpr const char kFalseValue[] = "false";

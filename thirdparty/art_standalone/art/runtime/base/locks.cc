...
__attribute__((visibility("default"))) MutatorMutex* Locks::mutator_lock_ = nullptr;
...
__attribute__((visibility("default"))) Mutex* Locks::thread_suspend_count_lock_ = nullptr;
Mutex* Locks::trace_lock_ = nullptr;
Mutex* Locks::unexpected_signal_lock_ = nullptr;
__attribute__((visibility("default"))) Mutex* Locks::user_code_suspension_lock_ = nullptr;

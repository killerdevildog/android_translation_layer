...
public class ColorStateList extends ComplexColor implements Parcelable {
	...
	public static ColorStateList valueOf(/*@ColorInt*/ int color) {
		synchronized (sCache) {
			...
			for (int i = N - 1; i >= 0; i--) {
				if (sCache.valueAt(i).get() == null) { // should be .refersTo(null)
					sCache.removeAt(i);
				}
			}
	...
	public String toString() {
		return "ColorStateList{"
		     + "mThemeAttrs=" + Arrays.deepToString(mThemeAttrs) + "mChangingConfigurations=" + mChangingConfigurations + "mStateSpecs=" + Arrays.deepToString(mStateSpecs) + "mColors=" + Arrays.toString(mColors) + "mDefaultColor=" + mDefaultColor + '}';
	}
	...
	/*public static final @android.annotation.NonNull Parcelable.Creator<ColorStateList> CREATOR = new Parcelable.Creator<ColorStateList>() {
		@Override
